...
ifdef QC_WIFI_HIDL_FEATURE_STA_SAP_P2P
LOCAL_CPPFLAGS += -DQC_WIFI_HIDL_FEATURE_STA_SAP_P2P
endif
ifdef QC_WIFI_HIDL_FEATURE_STA_DUAL_SAP_P2P
LOCAL_CPPFLAGS += -DQC_WIFI_HIDL_FEATURE_STA_DUAL_SAP_P2P
endif
LOCAL_SRC_FILES := \
