...
std::vector<V1_6::IWifiChip::ChipMode> removeDualSta(
        const std::vector<V1_6::IWifiChip::ChipMode> &modes) {
    std::vector<V1_6::IWifiChip::ChipMode> res = modes;
    typedef std::vector<android::hardware::wifi::V1_6::IWifiChip::ChipMode>::size_type size_t;
